...
import {handleValidationService} from '../../Services/handleValidation.service'
...
const Create_Campaigns = () => {
	...
	const handleChange = (e) => {
		...
		setValues({...values, [e.target.name]: value, formIsValid: false});
		const NewErrors = handleValidationService(values);
		setErrors({...NewErrors})
